...
const caseStudies = [
  ...
  },
  {
    ...
    desc: 'Translating the high-energy environment of a three-level gym and wellness center into a social media presence that drives membership and community engagement.',
        ...
        <div className="max-w-screen-xl mx-auto px-5 md:px-8">
          ...
          >
            ...
            <div className="text-center md:text-left flex flex-col items-center md:items-start">
              ...
              >
                Medici Social is a full-service digital marketing agency based in Houston, TX, specializing in social media management, content creation, website design, SEO, and AI workflow integrations for modern brands.
              </motion.p>
